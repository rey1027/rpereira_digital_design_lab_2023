...
# ACDS 22.1 915 win32 2023.05.08.20:05:25
# ----------------------------------------
...
# ----------------------------------------
# If pruebaclock is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "pruebaclock"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pruebaclock.vo"
}
